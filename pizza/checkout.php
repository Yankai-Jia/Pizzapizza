        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0"><?php echo $dish['name'];?></h6>
                        <small class="text-muted">quantity : <?php echo $dish['dish_qty'] ?></small>
                        <br>
                        <small class="text-muted">flavor : <?php echo $dish['flavor'] ?></small>
                    </div>
                    <span class="text-muted"><?php echo $dish['price'] * $dish['dish_qty']; ?></span>
                </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="telephone" placeholder="123-4567-0000" required>
                    <div class="invalid-feedback">
