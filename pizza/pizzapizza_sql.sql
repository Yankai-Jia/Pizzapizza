...
(10, 'Ultimate Cheese Lover\'s Pizza', 'mozzarella cheese, Garlic Parmesan sauce, and a toasted Parmesan crust', 19, 'veggie', 300, 'assets/uploads/10.PNG', 74, 0),
...
(19, 'Stuffed Pizza Roller', 'pepperoni & 100% real cheese made from Mozzarella, then sprinkled with Italian seasoning', 15, 'sides', 147, 'assets/uploads/19.png', 246, 0),
...
(26, 'HERSHEY\'S Triple Chocolate Brownie', 'Calling all chocolate lovers! This warm, triple chocolate brownie features Hershey\'s® Cocoa', 12, 'desserts', 195, 'assets/uploads/26.png', 330, 0),
...
(33, 'SIERRA MIST ', 'A crisp, refreshing & caffeine free Lemon-Lime flavor soda with real sugar and a splash of real juice.', 1.99, 'drinks', 900, 'assets/uploads/33.png', 1000, 0),
(34, 'Dr Pepper ', 'A signature blend of 23 flavors makes every sip truly unique. There\'s nothing like a Dr Pepper.', 1.99, 'drinks', 250, 'assets/uploads/34.png', 1000, 0),
(35, 'AQUAFINA ', 'The AQUAFINA brand’s reverse osmosis purification system means pure water and perfect taste every time.', 1.99, 'drinks', 0, 'assets/uploads/35.png', 1000, 0),
